...
1. [Failure Sketching: A Technique for Automated Root Cause Diagnosis of In-Production Failures](http://dslab.epfl.ch/pubs/gist.pdf)<br>
...
4. [Data Races vs. Data Race Bugs: Telling the Difference with Portend](http://dslab.epfl.ch/pubs/portend.pdf) [<a href= "{{ site.baseurl }}public/fs-slides.pdf">slides</a>]<br>
<b>Baris Kasikci</b>, Cristian Zamfir, and George Candea <br>
